...
public class Component_CartItem {
    ...
    @FXML
    private ImageView addToWishlistButton;
    
    private Producto producto;
    private Runnable onRemove;
    private Runnable onAddToWishlist;
    ...
    public void setOnAddToWishlist(Runnable onAddToWishlist) {
    ...
    @FXML
    private void handleAddToWishlist(MouseEvent event) {
        event.consume();
